  ...
  return (
    <div id="main-content" className="min-h-screen pb-safe">
      ...
      <div className="px-5 py-2 max-w-7xl mx-auto">
        <MiracleSearchBar asButton onClick={() => navigate('/explore')} />
      </div>
          ...
          {!isLoading &&
            [...featuredSalons, ...nearbySalons].slice(0, 3).map((salon) => (
              <div
                ...
                className="flex items-center gap-3.5 bg-card rounded-[20px] p-3 card-shadow cursor-pointer"
        ...
        <div className="pt-5 pb-3 max-w-7xl mx-auto">
          ...
          <div className="flex gap-3 overflow-x-auto px-5 pb-3 scrollbar-hide" style={{ contain: 'layout style' }}>
            {completedBookings.map((booking) => (
              <div key={booking.id} className="flex-shrink-0 w-60 bg-card rounded-[20px] p-3.5 card-shadow" style={{ border: '1px solid hsl(var(--border) / 0.4)' }}>
