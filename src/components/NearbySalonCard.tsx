...
const NearbySalonCard = memo(({ salon }: NearbySalonCardProps) => {
  ...
  return (
    <div
      ...
      className="flex-shrink-0 w-[200px] md:w-full bg-card rounded-[20px] overflow-hidden card-shadow cursor-pointer"
      style={{ contain: 'layout style paint', transition: 'transform 0.15s ease', border: '1px solid hsl(var(--border) / 0.4)' }}
    >
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between mt-2.5">
          ...
          <button
            ...
            className="text-[11px] font-heading font-semibold text-primary-foreground bg-primary px-3.5 py-1.5 rounded-xl min-h-[44px] min-w-[44px] flex items-center justify-center"
